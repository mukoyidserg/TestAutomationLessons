...
public class Runner {
	String descriptionPath = "C://Users//SERG//Downloads//TestAutomationLessons//Sergii Mukoid//src//lesson3//preintermediatelevel//TaskDescription";
	String writePath = "C://Users//SERG//Desktop//Tasks.xls";
	
	
	public void allPreintermediateTaskDisplay() {
	...
	public void preintermediateTaskWriteByNumber(int number) throws BiffException, WriteException {
		try (BufferedReader br = new BufferedReader(new FileReader(descriptionPath))) {
	...
	public void preintermediateTaskRun() throws BiffException, WriteException, InstantiationException, IllegalAccessException,
		...
		String taskName = "lesson3.preintermediatelevel.Task" + number;
	...
	public static void main(String[] args) throws BiffException, WriteException, ClassNotFoundException,
		...
		myInstance.preintermediateTaskRun();
	}
}
