...
public class Runner {
	String descriptionPath = "C://Users//SERG//Downloads//TestAutomationLessons//Sergii Mukoid//src//lesson3//advancedlevel//TaskDescription";
	String writePath = "C://Users//SERG//Desktop//Tasks.xls";
	
	
	public void alladvancedTaskDisplay() {
	...
	public void advancedTaskWriteByNumber(int number) throws BiffException, WriteException {
		try (BufferedReader br = new BufferedReader(new FileReader(descriptionPath))) {
	...
	public void advancedTaskRun() throws BiffException, WriteException, InstantiationException, IllegalAccessException,
		...
		String taskName = "lesson3.advancedlevel.Task" + number;
