...
public class Serg3 {
  ...
  public void setUp() throws Exception {
	  System.setProperty("webdriver.gecko.driver",
				"C://Users//Пользователь//git//TestAutomationLessons//Sergii Mukoid//src//lesson5//geckodriver.exe");
		...
		driver = new MarionetteDriver(capabilities);
		 baseUrl = "http://services.deloitte.ie/";
		  ...
		  public void testSerg6() throws Exception {
		    ...
		    assertEquals("€2,010.00", driver.findElement(By.id("ctl00_ContentPlaceHolder1_lblCYTaxLowerRate")).getText());
		  }
